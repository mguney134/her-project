                ...
                <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item  Mentor">
                            <a class="nav-link active" id="create-tab" data-toggle="tab" href="#create" role="tab" aria-controls="contact" aria-selected="false">Create</a>
                        </li>
                        <li class="nav-item Mentor">
                            <a class="nav-link " id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="contact" aria-selected="false">All</a>
                        </li>
                        <li class="nav-item Mentor">
                            <a class="nav-link  " id="saved-tab" data-toggle="tab" href="#saved" role="tab">Saved</a>
                        </li>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="../settings/action.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!-- type -->
                                                        <div class="col select-outline mb-3">
                                                            <?php
                                                            //Get all event type data
                                                            ...
                                                            ?>
                                                            <select class="browser-default custom-select mentor" id="target_group" name="target_group">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="eventadd" class="btn btn-sm btn-primary">Create</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="../settings/action.php" method="POST">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-sm btn-outline-primary" data-dismiss="modal">Close</button>
                                                    <button type="submit" class="btn btn-sm btn-primary" name="deleteevent">Delete</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="all" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="input-group md-form form-sm form-2 pl-0 mx-3 mb-4">
                                <input class="form-control my-0 py-1 border-primary" type="text" placeholder="Search networking post by name" aria-label="Search">
                                <div class="input-group-append">
                                    <span class="input-group-text blue accent-4" id="basic-text1"><i class="fas fa-search white-text" aria-hidden="true"></i></span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-12 col-xs-12">
                                    <div class="card testimonial-card">
                                        <div class="card-up">
                                            ...
                                            <!-- Bookmark icon -->
                                            <?php
                                            $proposedpostcheck = $db->prepare("SELECT * FROM proposed_post where mentor_id=:mentor_id and event_id=:event_id");
                                            $proposedpostcheck->execute(array(
                                            ...
                                            ?>
                                                <i class="fas fa-star icon icon-star fa-2x yellow-text mt-2"></i>
                                            <?php } else { ?>
                                                <i class="far fa-star icon icon-star fa-2x yellow-text mt-2"></i>
                                            <?php }
                                            $savedpostcheck = $db->prepare("SELECT * FROM savedpost where user_id=:user_id and event_id=:event_id");
                                            $savedpostcheck->execute(array(
                                                'user_id' => $_SESSION['user_id'],
