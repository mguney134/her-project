...
<div class="col-md-9 mb-4">
    ...
    <ul class="nav nav-tabs md-tabs nav-justified deep-orange lighten-2 mt-5" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="org-herbackground.php?her_id=<?php echo $herinfo['her_id'] ?>" role="tab">
        ...
        <li class="nav-item">
            <a class="nav-link" href="org-hernetworking.php?her_id=<?php echo $herinfo['her_id'] ?>" role="tab">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-md-12 grey lighten-4 rounded-left pt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                $bgcheck2->execute(array('user_id' => $herinfo['user_id']));
