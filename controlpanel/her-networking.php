                  ...
                  <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
                    <h3 class="font-weight-bold">Incoming Events</h3>
                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="picked-tab" data-toggle="tab" href="#picked" role="tab" aria-controls="profile"
                            aria-selected="false">Your Mentor's Picks for you</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade" id="all" role="tabpanel" >
                          <div class="row">
                              ...
                              <div class="input-group md-form form-sm form-2 pl-0 mx-3 mb-4">
                                  <input class="form-control my-0 py-1 amber-border" type="text" placeholder="Search in all the events" aria-label="Search">
