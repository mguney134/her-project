            ...
            <div class=" py-5 z-depth-1">
                ...
                <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
                    ...
                    <form action="../settings/action.php" method="POST" class="mx-5">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <select class="mdb-select md-form md-outline Her my-2" name="organisation" id="orgname">
                                    <option disabled selected><?php echo $mentorinfo['organisation'] ?></option>
                                    <?php
                                ...
                                <label for="orgname">Mentoring Organisation</label>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="md-form md-outline">
                                    <input type="text" id="birth" class="form-control" value="<?php echo $mentorinfo['birth'] ?>" name="birth" />
                        ...
                        <div class="form-row">
                            <div class="col select-outline">
                                <select class="mdb-select md-form md-outline my-2" id="cont" searchable="Search here.." name="country">
                        ...
                        <div class="form-row">
                            <div class="col select-outline">
                                <select class="mdb-select md-form md-outline my-2" id="stat" searchable="Search here.." name="legalStatus">
                        ...
                        <div class="form-row">
                            <div class="col select-outline">
                                <select class="mdb-select md-form md-outline my-2" id="levStu" searchable="Search here.." name="levelofStudy">
                        ...
                        <div class="form-row">
                            <div class="col select-outline">
                                <select class="mdb-select md-form md-outline my-2" id="worSec" searchable="Search here.." name="sector">
