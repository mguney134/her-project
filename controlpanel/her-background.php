            ...
            <div class="tab-pane fade in show active" >
                ...
                <!--Section: Content-->
                    <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
                        ...
                        <h3 class="font-weight">My Studies:</h3>
                        <hr />
                        <div class="row">
                            <div class="col-12 ">
                            <h4 class="list-group-item list-group-item-primary">Grades</h4><hr />
                            </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-12">
                            <h4 class="list-group-item list-group-item-success">Courses</h4><hr />
                            </div>
                    ...
                    <div class="col-12">
                        <h3 class="font-weight">My Experiences:</h3>
                        <hr />
                        <div class="row">
                            
                            <div class="col-12">
                            <h4 class="list-group-item list-group-item-warning">Jobs</h4><hr />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                            <h4 class="list-group-item list-group-item-info">Internships</h4><hr />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                            <h4 class="list-group-item list-group-item-secondary">Volunteerings</h4><hr />
                            </div>
