                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="media  grey lighten-5 text-orange z-depth-1 rounded">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <a data-toggle="modal" class="editbg" id="<?php echo $bginfo['background_id'] ?>" data-target="#editBackground"><i class="fas fa-pen m-1 "></i></a>
                                                                    </div>
                                                                </div>
                                                                <!--9-->
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="media grey lighten-5 text-orange z-depth-1 rounded">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <a data-toggle="modal" class="editbg" id="<?php echo $bginfo2['background_id'] ?>"><i class="fas fa-pen m-1 "></i></a>
                                                                    </div>
                                                                </div>
                                                                <!--9-->
                                                        ...
                                                        <div class="col-6 mb-4">
                                                            <div class="media  grey lighten-5 text-orange z-depth-1 rounded">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a data-toggle="modal" class="editbg" id="<?php echo $bginfo4['background_id'] ?>" data-target="#editBackground"><i class="fas fa-pen m-1 "></i></a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-6 mb-4">
                                                            <div class="media  grey lighten-5 text-orange z-depth-1 rounded">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a data-toggle="modal" class="editbg" id="<?php echo $bginfo3['background_id'] ?>" data-target="#editBackground"><i class="fas fa-pen m-1 "></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                        ...
                                                        <div class="col-6 mb-4">
                                                            <div class="media  grey lighten-5 text-orange z-depth-1 rounded">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a data-toggle="modal" class="editbg" id="<?php echo $bginfo5['background_id'] ?>" data-target="#editBackground"><i class="fas fa-pen m-1 "></i></a>
                                                                </div>
                                                            </div>
                                                            <input hidden value="">
                                                        </div>
