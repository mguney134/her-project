...
$meetcheck = $db->prepare("SELECT * FROM meetings WHERE mentor_id=:mentor_id");
$meetcheck->execute(array(
    'mentor_id' => $mentorinfo['mentor_id']
));

$whomcheck = $db->prepare("SELECT * FROM her where mentor_id=:mentor_id");
                            ...
                            <div class="modal-content">
                                ...
                                <form action="../settings/action.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <input hidden type="text" class="form-control" name="mentor_id" value="<?php echo $mentorinfo['mentor_id'] ?>">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-sm btn-outline-primary" data-dismiss="modal">Close</button>
                                        <button type="submit" name="mentoraddmeet" class="btn btn-sm btn-primary">Create Meeting</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-10 grey lighten-4 rounded-left pt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-6 mb-2">
                                                    ...
                                                    <p class="text-muted"><?php echo $mentorinfo['firstname']." ".$mentorinfo['lastname']; ?></p>
                                                </div>
                                                <div class="col-lg-3 col-md-6 mb-2">
