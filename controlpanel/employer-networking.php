...
<div class="col-md-9 mb-4">
    ...
    <ul class="nav nav-tabs md-tabs nav-justified purple lighten-2" role="tablist">
        <li class="nav-item">
            <a class="nav-link" href="employer-info.php" role="tab">
                <i class="fas fa-user pr-2"></i>Info</a>
        </li>

        <li class="nav-item">
            <a class="nav-link active" href="employer-networking.php" role="tab">
            ...
            <div class=" py-5 z-depth-1 ">
                <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active Employer" id="create-tab" data-toggle="tab" href="#create" role="tab">Create</a>
                        </li>
                            ...
                            <section class="p-md-3 mx-md-5 text-lg-left">
                                ...
                                <div class="row text-center my-3">
                                    <div class="col text-center">
                                        <button type="button" data-toggle="modal" data-target="#createPost" class="btn btn-md btn-purple ">Create a Networking Post</button>
                                    </div>
                                </div>
                                                ...
                                                <div class="card-up">
                                                    ...
                                                    <div class="<?php
                                                        ...
                                                        <div style="margin: 0;" class="row pb-2">
                                                            ...
                                                            <a data-toggle="modal" style="font-size:12px" data-val="<?php echo $myeventsinfo['event_id'] ?>" data-target="#deletePost"><i
                        ...
                        <div class="tab-pane fade" id="all" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="input-group md-form form-sm form-2 pl-0 mx-3 mb-4">
                                    <input class="form-control my-0 py-1 border-secondary" type="text" placeholder="Search networking post by name" aria-label="Search">
                                    <div class="input-group-append">
                                        <span class="input-group-text purple accent-4" id="basic-text1"><i class="fas fa-search white-text" aria-hidden="true"></i></span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-purple" id="exampleModalLabel">Create New Networking Post</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="eventadd" class="btn btn-sm btn-purple">Create</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="deletePost" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-outline-purple" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-sm btn-purple" name="deleteevent">Delete</button>
            </div>
            </form>
        </div>
    </div>
