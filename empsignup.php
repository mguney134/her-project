                        ...
                        <ul class="stepper linear Employer">
                                ...
                                <div class="step-new-content">
                                    ...
                                    <div class="form-row mb-2">
                                        <div class="col select-outline Employer">
                                            ...
                                            <button class="btn-save btn btn-secondary btn-sm">Save</button>
                                        </div>
                                        <div class="col">
                                            <div class="md-form md-outline Employer">
                                                <input name="employees" type="number" id="employees" class="form-control" />
                            ...
                            <li class="step">
                                ...
                                <div class="step-new-content">
                                    ...
                                    <div class="step-actions mb-5">
                                        <input class="btn btn-secondary" type="submit" name="hersignup" value="Submit">
                                    </div>
                                </div>
                            </li>
                        </ul>
